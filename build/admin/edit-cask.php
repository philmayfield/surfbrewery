					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<fieldset class="form-group">
								<label for="value">Cask Content</label>
								<textarea class="form-control" id="value" name="value" rows="2" placeholder="Cask Content"><?php if($item) echo $item->value; ?></textarea>
								<small>If nothing will be on cask, its okay to leave blank.</small>
							</fieldset>
