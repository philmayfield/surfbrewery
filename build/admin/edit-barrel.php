					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<fieldset class="form-group">
								<label for="value">Barrel Content</label>
								<textarea class="form-control" id="value" name="value" rows="2" placeholder="Barrel Content"><?php if($item) echo $item->value; ?></textarea>
								<small>If not serving anything from the barrel, its okay to leave blank.</small>
							</fieldset>
