    ...
    <body>
    	...
    	<main class="container m-y-2">
			...
			<section class="card card-block">
				...
				<h2><?php echo $item ? 'Editing '.$item->name : 'Adding New Band'; ?></h2>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-12 col-lg-5">
							...
							<fieldset class="form-group">
								...
								<input type="text" class="form-control" id="name" name="name" placeholder="Ex: The Doors" value="<?php if($item) echo $item->name; ?>" required>
							</fieldset>
						...
						<div class="col-xs-12 col-md-6 col-lg-4">
							...
							<fieldset class="form-group">
								<label for="description">Band Style</label>
								<input type="text" class="form-control" id="description" name="description" placeholder="Psychedelic Rock" value="<?php if($item) echo $item->description; ?>" required>
							</fieldset>
						...
						<div class="col-xs-12 col-md-6 col-lg-3">
							...
							<fieldset class="form-group">
								<label for="date">Band Date</label>
					...
					<div class="row">
						<div class="col-xs-12 text-xs-center text-sm-right">
							...
							<?php if ($item) {
									...
									?>
									<button type="submit" class="btn btn-primary">Add New Band</button>
									<?php
								}
							?>
						</div>
