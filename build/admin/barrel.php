    ...
    <body>
    	...
    	<main class="container m-y-2">
			...
			<section class="card card-block">
				...
				<a href="admin/edit-<?php echo $currPage; ?>.php?id=01" class="btn btn-primary surf-new-btn">Edit Barrel</a>

				<h5 class="m-t-1">Current Text for the Barrel section:</h5>

				<p>&ldquo;
				<?php 
				$get_item = $conn->prepare('SELECT * FROM barrel ORDER BY id ASC');
				$get_item->execute();
