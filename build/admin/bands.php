    ...
    <body>
    	...
    	<main class="container m-y-2">
			...
			<section class="card card-block">
				...
				<p>Prints in the <a href="tastingroom" target="_blank">Tasting Room</a> section of the site, if no future Bands have been input a message will display directing users to our social media pages.</p>

				<a href="admin/edit-<?php echo $currPage; ?>.php?id=new" class="btn btn-primary surf-new-btn">Add a New Band</a>
				...
				<div class="row">
					...
					<div class="surf-list-holder col-xs-12 col-lg-6">
						...
						<ul class="surf-list">
							...
							<?php 
							$get_items = $conn->prepare('SELECT * FROM bands ORDER BY date DESC');
							$get_items->execute();
							...
							<li class="surf-list-item">
								...
								<p class="small m-b-0"><?php echo $item->description; ?></p>
							</li>
